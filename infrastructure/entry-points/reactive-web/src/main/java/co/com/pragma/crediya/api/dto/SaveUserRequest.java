...
public class SaveUserRequest {
    ...
    @Pattern(regexp = ValidationPatterns.NAME_REGEX, message = ValidationErrorMessages.NAME_INVALID_FORMAT)
    ...
    @Pattern(regexp = ValidationPatterns.NAME_REGEX, message = ValidationErrorMessages.LASTNAME_INVALID_FORMAT)
    ...
    @Pattern(regexp = ValidationPatterns.OPTIONAL_LOCAL_DATE_REGEX, message = ValidationErrorMessages.INVALID_DATE_FORMAT)
